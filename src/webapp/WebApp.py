...
image = Image.open('C:/Users/Alex/PycharmProjects/barcelona-apartments-2/data/images/barcelona_long.png')
...
model = load('C:/Users/Alex/PycharmProjects/barcelona-apartments-2/data/models/ridge_model.joblib')
